...
class SendMail
{
	function sendGmail($_subject, $_body, $_address){
		...
		try {
		    ...
		    $mail->Username = 'ungthithuyoanh1998@gmail.com';                 // SMTP username
		    $mail->Password = 'onetrangvu98';                           // SMTP password
		    //tai khoan dang nhap va gui mail
		    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
		    $mail->Port = 587;                                    // TCP port to connect to
		 	$mail->CharSet = "UTF-8";
		    //Recipients
		    $mail->setFrom('ungthithuyoanh1998@gmail.com', 'Confirm account');
